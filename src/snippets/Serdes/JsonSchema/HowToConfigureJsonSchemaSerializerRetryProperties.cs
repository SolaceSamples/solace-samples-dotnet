...
namespace Snippets.Serdes.JsonSchema
{
    ...
    /// properties for a JSON Schema serializer. This class includes scenarios for:
    /// <list type="bullet">
    ...
    /// </list>
    /// </summary>
    public static class HowToConfigureJsonSchemaSerializerRetryProperties
    {
        /// <summary>
        ...
        /// </summary>
        public static void SerializeWithRequestAttempts()
        {
        ...
        /// </summary>
        public static void SerializeWithRequestAttemptBackoff()
        {
            // Create configuration dictionary
            var config = new Dictionary<string, object>();
        ...
        /// </summary>
        public static void SerializeWithCompleteRetryStrategy()
        {
            // Create configuration dictionary
            var config = new Dictionary<string, object>();
