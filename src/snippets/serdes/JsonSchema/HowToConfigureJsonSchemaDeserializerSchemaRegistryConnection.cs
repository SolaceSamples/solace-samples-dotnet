...
namespace Snippets.Serdes.JsonSchema
{
    ...
    /// </list>
    /// </summary>
    public static class HowToConfigureJsonSchemaDeserializerSchemaRegistryConnection
    {
        /// <summary>
        /// Demonstrates how to configure a JSON Schema deserializer with an authenticated Schema Registry endpoint.
        /// </summary>
        public static void DeserializeWithAuthenticatedSchemaRegistryEndpoint()
        {
        ...
        /// </summary>
        public static void DeserializeWithAuthenticatedSecureSchemaRegistryEndpoint()
        {
            // Create configuration dictionary
            var config = new Dictionary<string, object>();
